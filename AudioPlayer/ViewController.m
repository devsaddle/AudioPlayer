...
- (void)viewDidLoad {
    ...
    [[AudioPlayer shareManager] creatPlayList:@[[AudioItem itemWithUrl:[NSURL URLWithString:@"http://win.web.ra01.sycdn.kuwo.cn/resource/n1/192/29/57/3189494444.mp3"] itemID:@"1"]
                                                ,[AudioItem  itemWithUrl: [NSURL URLWithString:@"http://121.17.126.239/mp3.9ku.com/hot/2011/12-13/461514.mp3"]itemID:@"2"]
                                                ,[AudioItem itemWithUrl: [NSURL URLWithString:@"http://win.web.re01.sycdn.kuwo.cn/resource/n2/85/26/3377023046.mp3"] itemID:@"3" ]
                                                ]];
